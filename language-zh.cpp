...
N("Sand Worm W", GEN_N, "沙虫 W","虫","段")
N("Desert Man", GEN_N, "沙民","民","位")
N("Ivy Root", GEN_N, "常春藤根","藤","段")
N("Active Ivy", GEN_N, "活跃常春藤","藤","段")
N("Ivy Branch", GEN_N, "常春藤枝","藤","段")
N("Dormant Ivy", GEN_N, "休眠常春藤","藤","段")
N("Ivy N", GEN_N, "常春藤 N","藤","段")
N("Ivy D", GEN_N, "常春藤 D","藤","段")
N("Giant Ape", GEN_N, "巨猿","猿","只")
...
N("Fire Fairy", GEN_N, "烈焰仙灵","灵","位")
N("Crystal Sage", GEN_N, "水晶智者","智","位")
N("Hedgehog Warrior", GEN_N, "刺猬战士","猬","位")

// ITEMS
// =====

N("Ice Diamond", GEN_N, "冰钻","钻","枚")
N("Gold", GEN_N, "黄金","金","块")
N("Spice", GEN_N, "香料","香","捧")
N("Ruby", GEN_N, "红宝石","宝","枚")
N("Elixir of Life", GEN_N, "万灵药","药","个")
N("Shard", GEN_N, "裂片", "片","枚")
...
N("Jungle", GEN_N, "丛林","丛","")
N("Alchemist Lab", GEN_N, "炼金实验室","炼","")
N("Mirror Land", GEN_N, "镜之地","镜","")
N("Graveyard", GEN_N, "墓地","墓","")
N("R'Lyeh", GEN_N, "拉莱耶","拉","")
N("Hell", GEN_N, "地狱","地","")
N("Cocytus", GEN_N, "科赛特斯","科","")
N("Land of Eternal Motion", GEN_N, "永动之地","永","")
N("Dry Forest", GEN_N, "干燥森林","干","")
N("Game Board", GEN_N, "棋盘","棋","")
...
N("Emerald Mine", GEN_N, "绿宝石矿","绿","")
N("Pikeman", GEN_N, "长枪兵","长","名")
N("Flail Guard", GEN_N, "连枷守卫","连","名")
N("Miner", GEN_N, "矿工","矿","名")
N("Emerald", GEN_N, "绿宝石","绿","枚")
...
N("Vineyard", GEN_N, "藤蔓园","藤","")
N("Vine Beast", GEN_N, "藤蔓兽","兽","头")
N("Vine Spirit", GEN_N, "藤蔓精魂","魂","个")
N("vine", GEN_N, "藤蔓","藤","条")
N("partial fire", GEN_N, "部分起火","部","")
N("Wine", GEN_N, "红酒","酒","瓶")
...
N("Dead Cave", GEN_N, "死寂洞穴","死","")
N("Dark Troll", GEN_N, "黑暗巨魔","黑","只")
N("Earth Elemental", GEN_N, "土元素","土","个")
N("dead wall", GEN_N, "死寂墙","死","堵")
N("dead floor", GEN_N, "死寂地板","死","块")
N("rubble", GEN_N, "碎石","碎","堆")
N("Silver", GEN_N, "白银","银","块")
...
N("Hive", GEN_N, "虫巢","虫","")
N("Red Hyperbug", GEN_N, "红超虫","虫","只")
N("Green Hyperbug", GEN_N, "绿超虫","虫","只")
N("Blue Hyperbug", GEN_N, "蓝超虫","虫","只")
N("Royal Jelly", GEN_N, "蜂王浆","浆","团")
N("weird rock", GEN_N, "怪异岩石","怪","块")
...
N("Land of Power", GEN_N, "力量之地","力","")
N("Witch Apprentice", GEN_N, "女巫学徒","巫","名")
N("Speed Witch", GEN_N, "速度女巫","巫","名")
N("Flash Witch", GEN_N, "闪光女巫","巫","名")
N("Fire Witch", GEN_N, "火焰女巫","巫","名")
N("Aether Witch", GEN_N, "以太女巫","巫","名")
N("Winter Witch", GEN_N, "寒冬女巫","巫","名")
N("Evil Golem", GEN_N, "邪恶魔像","魔","个")
N("Powerstone", GEN_N, "魔力石","石","块")
N("crystal cabinet", GEN_N, "水晶柜","水","座")
...
N("Camelot", GEN_N, "卡美洛","卡","")
N("wall of Camelot", GEN_N, "卡美洛墙","卡","堵")
N("moat of Camelot", GEN_N, "卡美洛护城河","卡","条")
N("Round Table", GEN_N, "圆桌","圆","张")
N("Knight", GEN_N, "骑士","骑","位")
N("Holy Grail", GEN_N, "圣杯","杯","个")
...
N("Temple of Cthulhu", GEN_N, "克苏鲁神殿","克","")
N("big statue of Cthulhu", GEN_N, "克苏鲁大雕像","克","尊")
N("Grimoire", GEN_N, "巨著","巨","本")
N("Cult Leader", GEN_N, "邪教首领","邪","名")
...
N("Crossroads II", GEN_N, "交叉路口 II","交","")
...
N("Caribbean", GEN_N, "加勒比","加","")

N("Pirate", GEN_N, "海盗","盗","名")
N("Shark", GEN_N, "鲨鱼","鲨","条")
N("Parrot", GEN_N, "鹦鹉","鹦","只")
N("Pirate Treasure", GEN_N, "海盗宝藏","宝","堆")
N("Compass", GEN_N, "指南针","针","枚")

N("sea", GEN_N, "海","海","片")
N("boat", GEN_N, "船","船","条")
N("island", GEN_N, "岛屿","岛","座")
N("tree", GEN_N, "树","树","棵")
...
N("Red Rock Valley", GEN_N, "红岩谷","红","")

N("Rock Snake", GEN_N, "岩蛇","蛇","条")
N("Rock Snake Tail", GEN_N, "岩蛇尾","蛇","段")
N("Red Troll", GEN_N, "红巨魔","巨","只")
N("Red Gem", GEN_N, "赤色宝石","宝","枚")

N("rock I", GEN_N, "岩石 I","岩","")
N("rock II", GEN_N, "岩石 II","岩","")
N("rock III", GEN_N, "岩石 III","岩","")
...
N("Rogue", GEN_N, "游荡者","你","名")
N("Knife", GEN_N, "小刀","刀","把")
N("Flail", GEN_N, "连枷","枷","把")
N("Fireball", GEN_N, "火球","火","枚")
N("Tongue", GEN_N, "舌头","舌","根")
...
N("stranded boat", GEN_N, "搁浅的船","搁","条")
...
N("Minefield", GEN_N, "雷区","雷","")
N("minefield", GEN_N, "雷区","雷","处")
N("cell without mine", GEN_N, "没有雷的格子","没","块")
...
N("Tame Bomberbird", GEN_N, "驯服的炸弹鸟","鸟","只")
...
N("Bomberbird Egg", GEN_N, "炸弹鸟蛋","蛋","枚")
...
N("trapdoor", GEN_N, "活板门","活","道")
S("This floor will fall after someone goes there. Go quickly!",
  "这块地板会在有人走过之后坠落。快走！")

N("closed gate", GEN_N, "关闭的大门","关","道")
N("open gate", GEN_N, "开启的大门","开","道")
N("closing plate", GEN_N, "关闭压力盘","关","块")
N("opening plate", GEN_N, "开启压力盘","开","块")
...
N("Hypersian Rug", GEN_N, "超波斯地毯","超","块")
...
N("Viking", GEN_N, "维京人","维","名")
S("Mighty warriors from the Fjord, who can use boats.",
  "来自峡湾的强大战士，会驾驶船只。")

N("Water Elemental", GEN_N, "水元素","水","个")
...
N("Prince", GEN_N, "王子","王","名")
N("Princess", GEN_N, "公主","公","名")
...
N("Tentacle+Ghost", GEN_N, "触手+鬼魂","触","团")
...
N("Servant", GEN_N, "仆从","仆","名")
S("A simple servant of the master of the Ivory Tower.",
  "象牙塔主人的简单仆从。")

N("Gargoyle", GEN_N, "石像鬼","石","只")
N("stone gargoyle", GEN_N, "岩石石像鬼","岩","只")
N("stone gargoyle floor", GEN_N, "岩石石像鬼地板","岩","块")
N("stone gargoyle bridge", GEN_N, "岩石石像鬼桥","岩","段")
...
N("Ivory Figurine", GEN_N, "象牙小雕像","象","尊")
...
N("Platform", GEN_N, "平台","平","道")
N("platform", GEN_N, "平台","平","道")

S("You can stand here.", "你可以站在这里。")

N("ladder", GEN_N, "爬梯","爬","截")
...
N("temporary wall", GEN_N, "临时墙","临","堵")
N("temporary floor", GEN_N, "临时地板","临","块")
N("temporary bridge", GEN_N, "临时桥","临","段")
...
N("Elemental Planes", GEN_N, "元素位面","元","")
N("Plane of Fire", GEN_N, "火元素位面","火","")
N("Plane of Earth", GEN_N, "土元素位面","土","")
N("Plane of Air", GEN_N, "气元素位面","气","")
N("Plane of Water", GEN_N, "水元素位面","水","")
...
N("Fire Elemental", GEN_N, "火元素","火","个")

S("This monster leaves a trail of fire behind.",
  "这个怪物在身后留下一道火焰踪迹。")

N("Air Elemental", GEN_N, "气元素","气","个")
...
N("Fire Shard", GEN_N, "火焰碎片","火","块")
N("Air Shard", GEN_N, "空气碎片","空","块")
N("Water Shard", GEN_N, "水流碎片","水","块")
N("Earth Shard", GEN_N, "大地碎片","大","块")
N("Elemental Gem", GEN_N, "元素宝石","元","枚")
...
N("limestone wall", GEN_N, "石灰石墙","石","堵")
...
N("dead rock troll", GEN_N, "死岩石巨魔","死","个")
...
N("Wild West", GEN_N, "狂野西部","狂","")
N("Outlaw", GEN_N, "法外狂徒","法","名")
N("Bounty", GEN_N, "赏金","赏","份")
N("saloon wall", GEN_N, "沙龙墙","沙","堵")
N("Revolver", GEN_N, "左轮手枪","左","把")
...
N("Land of Storms", GEN_N, "风暴之地","风","")
N("charged wall", GEN_N, "荷电墙","荷","堵")
N("grounded wall", GEN_N, "接地墙","接","堵")
N("metal wall", GEN_N, "金属墙","金","堵")
N("sandstone wall", GEN_N, "沙石墙","沙","堵")
N("Storm Troll", GEN_N, "风暴巨魔","风","只")
N("Metal Beast", GEN_N, "金属兽","金","头")
N("Rich Metal Beast", GEN_N, "富金属兽","富","头")
N("electric discharge", GEN_N, "放电电荷","放","道")
...
N("Overgrown Woods", GEN_N, "莽林","莽","")
N("Mutant Ivy", GEN_N, "变异常春藤","变","段")
N("Mutant Sapling", GEN_N, "变异苗","变","株")
N("Forest Troll", GEN_N, "森林巨魔","森","只")
...
N("Clearing", GEN_N, "林间空地","林","")

N("Mutant Fruit", GEN_N, "变异果","变","颗")

N("Giant Fox", GEN_N, "巨狐","巨","只")
...
N("Friendly Ghost", GEN_N, "友善鬼魂","友","个")
...
N("White Dove Feather", GEN_N, "白鸽羽","白","根")
S("This feather is truly beautiful and strong.",
  "这根羽毛真是又美丽又强韧。")

N("Wind Crow", GEN_N, "风鸦","风","只")
...
N("Crossroads IV", GEN_N, "交叉路口 IV","交","")
...
N("Rose Garden", GEN_N, "玫瑰园","玫","")
N("False Princess", GEN_N, "假公主","假","位")
N("False Prince", GEN_N, "假王子","假","位")
N("Rose Lady", GEN_N, "玫瑰夫人","玫","位")
N("Rose Lord", GEN_N, "玫瑰领主","玫","位")
N("Rose Beauty", GEN_N, "玫瑰美人","玫","位")
N("Handsome Gardener", GEN_N, "俊俏园丁","俊","位")
N("rosebush", GEN_N, "玫瑰丛","玫","片")

Orb("Beauty", "美丽")
N("Thornless Rose", GEN_N, "无刺玫瑰","无","朵")
...
N("Warped Coast", GEN_N, "扭曲海岸","扭","")
N("Warped Sea", GEN_N, "扭曲大海","扭","")
N("Ratling", GEN_N, "鼠人","鼠","只")
N("Coral", GEN_N, "珊瑚","珊","块")
Orb("the Warp", "扭曲")
...
N("no wall", GEN_N, "无墙","无","")
N("no monster", GEN_N, "无怪物","无","")
N("no item", GEN_N, "无物品","无","")
...
N("Ratling Avenger", GEN_N, "鼠人复仇者","鼠","名")
...
N("Yendorian Forest", GEN_N, "Yendor森林","Y","")
...
N("Yendorian Researcher", GEN_N, "Yendor研究员","研","名")
...
N("Dragon Chasms", GEN_N, "巨龙裂隙","巨","")

N("Dragon", GEN_N, "巨龙","龙","条")

N("Dragon Scale", GEN_N, "龙鳞","鳞","片")
...
N("Galápagos", GEN_N, "加拉帕戈斯","加","")

N("Baby Tortoise", GEN_N, "小陆龟","龟","只")
...
N("Sunken Treasure", GEN_N, "沉没宝藏","宝","份")
...
N("Ancient Jewelry", GEN_N, "远古珠宝","珠","份")
...
N("Vampire Bat", GEN_N, "吸血蝙蝠","蝠","只")
N("Halloween", GEN_N, "万圣节","万","")
N("Treat", GEN_N, "糖果","糖","颗")
...
N("Amethyst", GEN_N, "紫水晶","晶","枚")

S("A beatiful purple gem from the Lost Mountain.",
  "来自失落山脉的紫色宝石。")

Orb("Nature", "自然")
N("Friendly Ivy", GEN_N, "友善常春藤","藤","段")
...
N("Reptiles", GEN_N, "爬行","爬","")
N("Reptile", GEN_N, "爬行类","爬","只")
N("Reptile floor", GEN_N, "爬行类地板","爬","块")
N("Reptile bridge", GEN_N, "爬行类桥","爬","段")
...
N("Prairie", GEN_N, "大草原","大","")
N("Green Grass", GEN_N, "绿草","草","株")
...
N("Bull Dash", GEN_N, "奔牛","奔","")
N("Butterfly", GEN_N, "蝴蝶","蝶","只")
N("Spinel", GEN_N, "尖晶石","石","枚")
...
N("Cellular Automaton", GEN_N, "元胞自动机","元","组")
...
S("torus", "环面")
S(" (click to use)", "（点击使用）")
N("Hall of Mirrors", GEN_N, "镜像大厅","镜","")
Orb("the Mirror", "镜像")
N("Reflection", GEN_N, "映像", "映","个")
N("mirror wall", GEN_N, "镜墙", "镜","堵")

S("This would only move you deeper into the trap!",
  "这只会让你陷得更深！")

S("You swing your sword at the mirror.", "你对镜子挥剑。")
N("Mimic", GEN_N, "模仿者","仿","个")
N("Narcissist", GEN_N, "自恋狂","恋","个")
N("Mirror Spirit", GEN_N, "镜像精魂","魂","个")
...
N("Kraken", GEN_N, "海妖","妖","只")
N("Kraken Tentacle", GEN_N, "海妖触手","手","条")
S(" (killing increases treasure spawn)", "（击杀增加宝藏刷新率）")

N("stepping stones", GEN_N, "垫脚石","垫","块")
...
N("Hunting Dog", GEN_N, "狩猎犬","犬","条")
N("Hunting Dog (guarding)", GEN_N, "狩猎犬（看守中）","犬","只")
N("Turquoise", GEN_N, "绿松石","石","枚")
Orb("Ferocity", "凶残")
...
N("Volcanic Wasteland", GEN_N, "火山荒原","火","")
N("lava", GEN_N, "熔岩","熔","滩")
...
N("mercury river", GEN_N, "汞河","汞","条")
S("A river of mercury.", "一条水银河流。")

N("Terracotta Warrior", GEN_N, "兵马俑战士","兵","尊")

N("Jiangshi", GEN_N, "僵尸","僵","个")
...
N("Ancient Weapon", GEN_N, "远古兵器","古","柄")
...
N("Blizzard", GEN_N, "暴风雪","暴","")
N("Ice Golem", GEN_N, "冰魔像","魔","座")
N("Void Beast", GEN_N, "虚空兽","虚","头")
N("Forgotten Relic", GEN_N, "遗忘之物","物","件")
...
N("Hunting Dog (regrouping)", GEN_N, "狩猎犬（撤退）","犬","条")
...
// Crystal World
N("Crystal World", GEN_N, "水晶世界","水","")
N("Glowing Crystal", GEN_N, "生长水晶","晶","块")
...
N("dock", GEN_N, "港口","港","处")
S("A dock.", "一处海港。")
N("burning dock", GEN_N, "燃烧港口","燃","处")
S("A burning dock.", "一处着火的港口。")

N("Sea Glass", GEN_N, "海玻璃","璃","块")

// Snake Nest

N("Snake Nest", GEN_N, "蛇巢","巢","")

N("Snake Oil", GEN_N, "蛇油","油","瓶")

S("Made of actual snakes!", "含有真蛇成分！")

// Ruined City

N("Ruined City", GEN_N, "城市废墟", "城","")
...
N("ruin wall", GEN_N, "废墟墙","废","堵")

N("Chrysoberyl", GEN_N, "金绿宝石","宝","枚")
S("Fragment of the past glory.", "Fragment dawnej chwały过去荣耀的碎片。")

N("Red Raider", GEN_N, "红劫掠者","掠","名")
...
N("Red Jelly", GEN_N, "红果冻","冻","块")
N("Blue Jelly", GEN_N, "蓝果冻","冻","块")

N("Tasty Jelly", GEN_N, "可口果冻","冻","块")
...
N("Falling Dog", GEN_N, "坠落犬","犬","条")

S("Distant relatives of the Running Dogs.", "奔行犬的远亲。")

N("Western Hawk", GEN_N, "西域鹰","鹰","只")

N("Meteorite", GEN_N, "陨石","陨","颗")
...
N("Irradiated Field", GEN_N, "辐射场","辐","")
...
N("Explosive Barrel", GEN_N, "爆炸桶","爆","个")
...
#define Curse(E, P) N("Curse of " E, GEN_N, P"诅咒","诅","")
Curse("Weakness", "虚弱")
