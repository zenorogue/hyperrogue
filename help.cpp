...
EX void buildCredits() {
  ...
  help += XLAT(
    ...
    "Piotr Grochowski, Ann, still-flow, tyzone, Paradoxica, LottieRatWorld, aismallard, albatross, EncodedSpirit, Jacob Mandelson, CrashTuvai, cvoight, jennlbw, Kali Ranya, spiritbackup, Dylan"
    );
#ifdef EXTRALICENSE
  help += EXTRALICENSE;
#endif
