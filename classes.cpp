...
vector<geometryinfo> ginf = {
  ...
  {"{4,3,3}","none",    "{3,3,4} 8-cell",                             "433",      6, 4, qsSMALLB,  gcSphere,     0x38400, {{SEE_ALL, SEE_ALL}}, eVariation::pure},
  {"{4,3,3}","elliptic","{3,3,4} 8-cell (elliptic)",                  "e433",     6, 4, qsSMALLBE, gcSphere,     0x39400, {{SEE_ALL, SEE_ALL}}, eVariation::pure},
