...
vector<geometryinfo> ginf = {
  ...
  {"bin{4,4}",  "none", "{4,4} on horospheres",                       "bin44",    9, 4, 0,         gcHyperbolic, 0x30000, {{7, 3}}, eVariation::pure},
  ...
  {"rh{4,3,4}","none",  "rhombic dodecahedral honeycomb",             "rh434",   12, 4, 0,         gcEuclid,     0x31000, {{7, 5}}, eVariation::pure},
  ...
  {"{4,3,5}","none",    "{4,3,5} hyperbolic honeycomb",               "435",      6, 4, 0,         gcHyperbolic, 0x31600, {{7, 2}}, eVariation::pure},
