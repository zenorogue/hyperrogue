...
pkgdatadir = $(datadir)/hyperrogue
pkgincludedir = $(includedir)/hyperrogue
pkglibdir = $(libdir)/hyperrogue
pkglibexecdir = $(libexecdir)/hyperrogue
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = hyperrogue$(EXEEXT)
noinst_PROGRAMS = langen$(EXEEXT)
subdir = .
...
langen_OBJECTS = $(am_langen_OBJECTS)
langen_LDADD = $(LDADD)
AM_V_P = $(am__v_P_$(V))
...
am__v_CXXLD_1 = 
SOURCES = $(hyperrogue_SOURCES) $(langen_SOURCES)
DIST_SOURCES = $(hyperrogue_SOURCES) $(langen_SOURCES)
...
STRIP = 
VERSION = 6.6
abs_builddir = /home/nobrakal/Documents/hyperrogue-git
abs_srcdir = /home/nobrakal/Documents/hyperrogue-git
abs_top_builddir = /home/nobrakal/Documents/hyperrogue-git
abs_top_srcdir = /home/nobrakal/Documents/hyperrogue-git
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
hyperrogue$(EXEEXT): $(hyperrogue_OBJECTS) $(hyperrogue_DEPENDENCIES) $(EXTRA_hyperrogue_DEPENDENCIES) 
	@rm -f hyperrogue$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(hyperrogue_OBJECTS) $(hyperrogue_LDADD) $(LIBS)

langen$(EXEEXT): $(langen_OBJECTS) $(langen_DEPENDENCIES) $(EXTRA_langen_DEPENDENCIES) 
	@rm -f langen$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(langen_OBJECTS) $(langen_LDADD) $(LIBS)
...
install-dist_hyperrogueDATA: $(dist_hyperrogue_DATA)
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(hyperroguedir)'"; \
